...
/*
This function inputs are whether you are hungry or not, and how much time you have available for lunch.
Using those two bits of information te function suggests what you could do for lunch that day
*/

function whatToDoForLunch(hungry, availableTime) {
  if (hungry == false) {
    console.log("Get back to work until you're hungry")
  }
